...
/***/ function(module, exports, __webpack_require__) {
	...
	var _project_creator_searchSearchBoxJs = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _projectCreatorJs = __webpack_require__(159);

	var _projectCreatorJs2 = _interopRequireDefault(_projectCreatorJs);
	...
	var WatchList = (function (_React$Component) {
	    ...
	    _createClass(WatchList, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var projectCreators = this.state.projectCreators.map(function (projectCreator) {
	                return _react2['default'].createElement(_projectCreatorJs2['default'], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectCreator = (function (_React$Component) {
	    _inherits(ProjectCreator, _React$Component);

	    function ProjectCreator() {
	        _classCallCheck(this, ProjectCreator);

	        _get(Object.getPrototypeOf(ProjectCreator.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(ProjectCreator, [{
	        key: "render",
	        value: function render() {
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { className: "header", href: this.props.url_web },
	                        this.props.name
	                    ),
	                    _react2["default"].createElement(
	                        "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchResultJs = __webpack_require__(165);
	        ...
	        value: function render() {
	            ...
	            if (!this.props.hasResults) {
	                ...
	                searchResults = _react2['default'].createElement(
	                    'div',
	                    { className: 'results visible transition' },
	                    projectCreators
	                );
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signInJs = __webpack_require__(169);

	var _signInJs2 = _interopRequireDefault(_signInJs);

	var _signUpJs = __webpack_require__(170);

	var _signUpJs2 = _interopRequireDefault(_signUpJs);
	...
	var AuthForm = (function (_React$Component) {
	    ...
	    function AuthForm(props) {
	        ...
	        _get(Object.getPrototypeOf(AuthForm.prototype), 'constructor', this).call(this);
	        this.state = {
	    ...
	    _createClass(AuthForm, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var presentSignInForm = this.state.presentSignInForm;

	            var form = undefined;
	            if (this.state.presentSignInForm) {
	                form = _react2['default'].createElement(_signInJs2['default'], { onSubmit: this.state.submitButtonAction });
	            } else {
	                form = _react2['default'].createElement(_signUpJs2['default'], { onSubmit: this.state.submitButtonAction });
	            }
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('input', { type: 'submit', value: 'Sign In', className: 'ui fluid large blue submit button' })
	                ),
